...
class QolsysDB():
    ...
    def add_zwave_node(self,_id:str,version:str,opr:str,partition_id:str,node_id:str,node_name:str,node_type:str,node_status:str,node_secure_cmd_cls:str,
                       ...
                       endpoint_details:str,device_wakeup_time:str,role_type:str,is_device_sleeping:str,counters_passed:str,counters_failed:str,group_id:str,
        ...
        self.cursor.execute(f'''INSERT INTO {self.Table_ZwaveContentProvider} (_id,version,opr,partition_id,node_id,node_name,node_type,node_status,node_secure_cmd_cls,node_battery_level,
                            ...
                            multi_channel_details,rediscover_status,last_rediscover_time,neighbour_info,last_node_test_time,endpoint_details,device_wakeup_time,
                            ...
                            neighbour_info,last_node_test_time,endpoint_details,device_wakeup_time,role_type,is_device_sleeping,counters_passed,counters_failed,group_id,command_classes_version,paired_status,
