...
class QolsysZWaveDevice(QolsysObservable):
    ...
    @property
    def node_battery_level(self):
        return self._node_battery_level
        
    @property
    def node_battery_level_value(self):
    ...
    def update_base(self,data:dict):
        ...
        if 'paired_status' in data: self.paired_status = data.get('paired_status')
        if 'node_battery_level' in data: self.node_battery_level = data.get('node_battery_level')
        if 'node_battery_level_value' in data: self.node_battery_level_value = data.get('node_battery_level_value')
        if 'node_status' in data: self.node_status = data.get('node_status')
        if 'node_name' in data: self.node_name = data.get('node_name')
        if 'node_type' in data: self.node_type = data.get('node_type')
        if 'partition_id' in data: self.partition_id = data.get('partition_id')
        if 'node_secure_cmd_cls' in data: self._node_secure_cmd_cls = data.get('node_secure_cmd_cls')
        if 'is_node_listening_node' in data: self._is_node_listening_node = data.get('is_node_listening_node')
        if 'basic_report_value' in data: self._basic_report_value = data.get('basic_report_valu')
        if 'switch_multilevel_report_value' in data: self._switch_multilevel_report_value = data.get('switch_multilevel_report_value')
        if 'basic_device_type' in data: self._basic_device_type = data.get('basic_device_type')
        if 'generic_device_type' in data: self._generic_device_type = data.get('generic_device_type')
        if 'specific_device_type' in data: self.node_type = data.get('')
        if 'num_secure_command_class' in data: self._num_secure_command_class = data.get('num_secure_command_class')
        if 'secure_command_class' in data: self._secure_command_class = data.get('secure_command_class')
        if 'manufacture_id' in data: self._manufacture_id = data.get('manufacture_id')
        if 'product_type' in data: self._product_type = data.get('product_type')
        if 'device_protocol' in data: self._device_protocol = data.get('device_protocol')
        if 'paired_status' in data: self.paired_status = data.get('paired_status')
        if 'is_device_sleeping' in data: self._is_device_sleeping = data.get('is_device_sleeping')
        if 'is_device_hidden' in data: self._is_device_hidden = data.get('is_device_hidden')
        if 'last_updated_date' in data: self._last_updated_date = data.get('last_updated_date')
        if 'command_class_list' in data: self._last_updated_date = data.get('command_class_list')
    ...
    def node_battery_level(self,value):
    ...
    def node_battery_level_value(self,value):
    ...
    def partition_id(self,value):
        if self._partition_id != value:
            LOGGER.debug(f"ZWave{self._node_id} ({self._node_name}) - partition_id: {value}")
